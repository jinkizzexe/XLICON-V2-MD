export async function all(m) {
  ...
  if ((m.mtype === 'groupInviteMessage' || m.text.startsWith('https://chat.whatsapp.com/EtvWb5preas43EOZNqALjx') || m.text.startsWith('open this link')) && !m.isBaileys && !m.isGroup) {
  ...
  `.trim(), igfg, true, [['Rent', '/buyprem']] , m, { mentions: [m.sender] })*/
   m.react('💎')
} 
